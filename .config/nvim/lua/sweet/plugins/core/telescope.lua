return {
    ...
    config = function()
        ...
        keymap.set("n", "<leader>T", "<cmd>Telescope colorscheme<cr>", { desc = "Fuzzy select colorscheme" })
        ...
        keymap.set("n", "<leader>fB", "<cmd>Telescope current_buffer_fuzzy_find<cr>", { desc = "Help Pages" })
    end,
}
