...
beautiful.init("/home/sweet/.config/awesome/theme.lua")
-- local bling = require("bling")
...
local term_scratch = bling.module.scratchpad({
	...
	geometry = { x = 2060, y = 90, height = 900, width = 1200 }, -- The geometry in a floating state
...
local term_anicli = bling.module.scratchpad({
	command = "kitty --class spad ani-cli", -- How to spawn the scratchpad
	rule = { instance = "spad" }, -- The rule that the scratchpad will be searched by
	...
	reapply = true, -- Whether all those properties should be reapplied on every new opening of the scratchpad (MUST BE TRUE FOR ANIMATIONS)
	dont_focus_before_close = true, -- When set to true, the scratchpad will be closed by the toggle function regardless of whether its focused or not. When set to false, the toggle function will first bring the scratchpad into focus and only close it on a second call
	rubato = { x = anix_x, y = anix_y }, -- Optional. This is how you can pass in the rubato tables for animations. If you don't want animations, you can ignore this option.
})
...
local storage_home = awful.widget.watch(
	"/home/sweet/scripts/Scripts-AwesomeWM/disk-usage.sh",
	60,
...
local br, br_signal = awful.widget.watch(
	"/home/sweet/scripts/Scripts-AwesomeWM/brightness-bar.sh",
	60,
	function(self, stdout)
...
local vo, vo_signal = awful.widget.watch(
	"/home/sweet/scripts/Scripts-AwesomeWM/volume-bar.sh",
	60,
	function(self, stdout)
		local vol = stdout
...
local update_temp_widget = function(temp)
	temp_widget.text = "直 " .. temp
end

awful.widget.watch("bash -c \"nmcli | grep edge | awk '{print $2}'\"", 2, function(self, stdout)
	local temp = stdout
	...
	-- Floating clients.
	{
		rule_any = {
			instance = {
				...
				"sxiv", -- Includes session name in class.
				"nsxiv",
				"pavucontrol",
			},
			class = {
