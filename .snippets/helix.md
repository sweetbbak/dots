Keymap
1. [Helix](title-page.html "title-page.html")
2. [**1.** Installation](install.html "install.html")
3. [**2.** Usage](usage.html "usage.html")
4. 1. [**2.1.** Keymap](keymap.html "keymap.html")
	2. [**2.2.** Commands](commands.html "commands.html")
	3. [**2.3.** Language Support](lang-support.html "lang-support.html")
5. [**3.** Migrating from Vim](from-vim.html "from-vim.html")
6. [**4.** Configuration](configuration.html "configuration.html")
7. 1. [**4.1.** Themes](themes.html "themes.html")
	2. [**4.2.** Key Remapping](remapping.html "remapping.html")
	3. [**4.3.** Languages](languages.html "languages.html")
8. [**5.** Guides](guides/index.html "guides/index.html")
9. 1. [**5.1.** Adding Languages](guides/adding_languages.html "guides/adding_languages.html")
	2. [**5.2.** Adding Textobject Queries](guides/textobject.html "guides/textobject.html")
	3. [**5.3.** Adding Indent Queries](guides/indent.html "guides/indent.html")
...
* [Normal mode](#normal-mode "#normal-mode")
	...
	+ [Changes](#changes "#changes")
		- [Shell](#shell "#shell")
	+ [Selection manipulation](#selection-manipulation "#selection-manipulation")
	+ [Search](#search "#search")
	+ [Minor modes](#minor-modes "#minor-modes")
		- [View mode](#view-mode "#view-mode")
		- [Goto mode](#goto-mode "#goto-mode")
		- [Match mode](#match-mode "#match-mode")
		- [Window mode](#window-mode "#window-mode")
		- [Space mode](#space-mode "#space-mode")
			* [Popup](#popup "#popup")
		- [Unimpaired](#unimpaired "#unimpaired")
* [Insert Mode](#insert-mode "#insert-mode")
* [Select / extend mode](#select--extend-mode "#select--extend-mode")
...
| Key | Description | Command |
| --- | --- | --- |
| `v` | Enter [select (extend) mode](#select--extend-mode "#select--extend-mode") | `select_mode` |
| `g` | Enter [goto mode](#goto-mode "#goto-mode") | N/A |
| `m` | Enter [match mode](#match-mode "#match-mode") | N/A |
| `:` | Enter command mode | `command_mode` |
| `z` | Enter [view mode](#view-mode "#view-mode") | N/A |
| `Z` | Enter sticky [view mode](#view-mode "#view-mode") | N/A |
| `Ctrl-w` | Enter [window mode](#window-mode "#window-mode") | N/A |
| `Space` | Enter [space mode](#space-mode "#space-mode") | N/A |

#### [View mode](#view-mode "#view-mode")

Accessed by typing `z` in [normal mode](#normal-mode "#normal-mode").
...
Accessed by typing `g` in [normal mode](#normal-mode "#normal-mode").
...
#### [Match mode](#match-mode "#match-mode")
Accessed by typing `m` in [normal mode](#normal-mode "#normal-mode").

See the relevant section in [Usage](./usage.html "./usage.html") for an explanation about
[surround](./usage.html#surround "./usage.html#surround") and [textobject](./usage.html#textobjects "./usage.html#textobjects") usage.
...
Accessed by typing `Ctrl-w` in [normal mode](#normal-mode "#normal-mode").
...
#### [Space mode](#space-mode "#space-mode")
Accessed by typing `Space` in [normal mode](#normal-mode "#normal-mode").
...
| `k` | Show documentation for item under cursor in a [popup](#popup "#popup") (**LSP**) | `hover` |
...
| `w` | Enter [window mode](#window-mode "#window-mode") | N/A |
...
#### [Unimpaired](#unimpaired "#unimpaired")
Mappings in the style of [vim-unimpaired](https://github.com/tpope/vim-unimpaired "https://github.com/tpope/vim-unimpaired").
